...
def create_feature_vector_for_frame(contours):
    vec = []
...
def get_feature_vector(video):
    ...
    while(cap.isOpened()):
        ...
        frame_feature_vector = create_feature_vector_for_frame(contours)
        frame_feature_vector.extend([0]*(1000-len(frame_feature_vector)))
        frame_feature_vector = frame_feature_vector[:1000]
        if len(frame_feature_vector)!=1000:
